Feature: Cadastrar um novo usuario no sistema
  ...
  Scenario: Cadastrar um novo usuario no sistema
    ...
    When Eu digito "Biu" para o nome, "123" para a senha, "Fulano" para o primeiro nome e "Lima" para o sobrenome
    And Seleciono "CIn"
  ...
  Scenario: Cadastrar um novo usuario no sistema com valor numerico
    Given Estou na pagina de cadastrar usuario
    When Eu digito "123" para o nome, "123" para a senha, "123" para o primeiro nome e "123" para o sobrenome
    And Seleciono "CIn"
    And Clico no botao cadastrar
    Then Eu continuo na pagina de cadastro
  
  Scenario: Cadastrar um mesmo usuario mais de uma vez no sistema
    Given O sistema tem um usuario com o nome "Biu", senha "123", primeiro nome "Fulano" e sobrenome "Lima"
    When Eu tento cadastrar um novo usuario com o nome "Biu", senha "123", primeiro nome "Fulano" e sobrenome "Lima"
